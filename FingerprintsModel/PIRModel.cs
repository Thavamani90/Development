...
namespace FingerprintsModel
{
    public class PIRModel
    {
        ...
        public string C52A { get; set; }
        public string C52B { get; set; }
        public string C52C { get; set; }
        public string C52D { get; set; }
        public string C52E { get; set; }

        public string C52A1 { get; set; }
        public string C52B1 { get; set; }
        public string C52C1 { get; set; }
        public string C52D1 { get; set; }
        public string C52E1 { get; set; }
        public string C_27_ChildDisabilityCount { get; set; }
        public string C_27_ReceivedServiceCount { get; set; }
    }



    public class DisabilityPIR
    {
    ...
    public class DisabilitiesType
    {
        public string ID { get; set; }
        public string DisabilityType { get; set; }
        public string QualifiedChildrenCount { get; set; }
        public string ServiceReceivedChildrenCount { get; set; }
    }
}
